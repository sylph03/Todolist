...
const Auth = () => {
  ...
  return (
    <div className='min-h-screen flex items-center justify-center bg-no-repeat bg-center bg-cover bg-[url(https://i.pinimg.com/originals/49/cd/d8/49cdd838e8c6d7fe5e2dd55deead5567.gif)]'>
