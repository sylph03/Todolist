...
const OptionItemCard = forwardRef(({ icon, label, isDanger, onClick, isFileUpload, isLeftPosition, isActive = false }, ref) => {
  return (
    <div
      ref={ref}
      ...
      className={`${isDanger
        ...
        border-gray-300 hover:bg-gray-100 dark:border-gray-600 dark:hover:bg-gray-800 ${isActive ? 'bg-gray-100 dark:bg-gray-800' : 'bg-white dark:bg-gray-900'}
