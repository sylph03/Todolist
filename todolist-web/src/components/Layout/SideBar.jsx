...
import { ChevronLeft, ChevronRight, Search, Sparkles, ChevronDown, FolderOpen } from 'lucide-react'
...
const SideBar = ({ isOpen, toggleSidebar }) => {
  return (
    <>
      ...
      <div className={`z-1 absolute top-0 bottom-0 h-full max-w-WIDTH_SIDEBAR min-w-WIDTH_SIDEBAR bg-sky-500 dark:bg-gray-800 shadow-md overflow-y-auto ${isOpen ? 'animate-fadeInLeft' : 'animate-fadeOutLeft'}`}>
        <div className='flex items-center justify-between w-full p-4 border-b border-gray-50'>
          ...
          <button className='justify-end p-1 rounded-md hover:bg-white/20' onClick={toggleSidebar}>
